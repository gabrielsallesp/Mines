...
// Funcao responsavel por espalhar as minas no tabuleiro
const spreadMines = (board, minesAmount) => {
    ...
    while (minesPlanted < minesAmount) {
        ...
        // Planto a mina no campo, se puder
...
// Chama as funcoes e cria o tabuleiro com as minas
...
// Funcao faz clone no campo minado para alteracao de estado
...
// Funcao valida os vizinhos de um campo
...
// Responsavel por verificar se a vizinhanca é segura
...
// Funcao responsavel por plantar ou desplantar a bandeira no campo
...
const hadExplision = board => fields(board).filter(field => field.exploded).length > 0
